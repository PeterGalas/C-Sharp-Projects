...
namespace Daily_Student_Report_Tech_Academy
{
    class Program
    {
        static void Main()
        {
           ...
           // //no implict conversions available from a float or double to decimal, these conversions must be explicity because of the data types

           // //implict cast from int to dec

           // decimal num22 = 7.0320923m;
           // int num23 = 5;
           // decimal answer = num22 + num23;
           // Console.WriteLine(answer);

           // //or this sbyte will give a similiar answer

           // decimal num24 = 7.0320923m;
           // sbyte num25 = 5;
           // decimal answers = num24 + num25;
           // Console.WriteLine(answers);

           // // math operations can be done on strings

           // string firstName = "Peter";
           // string lastName = "Galas";
           // Console.WriteLine(firstName + "" + lastName);

           // string name = "Jesse";
           // int num99 = 001;
           // Console.WriteLine(name + num99);
           // // compiler implicitly converted the int called num99 to string data type (+) is the only math operator available to strings
           // // addition operators applied to strings is called concatenation

            //int total1 = 5 + 10;
            //int otherTotal1 = 12 + 22;
            //int combined = total1 + otherTotal1;
            ////2nd try Console.WriteLine(combined);
            //Console.WriteLine("five plus ten = " + total1.ToString());
            //Console.ReadLine();
            ...
            // <= or >= == checks for equality (!) means opposite 
